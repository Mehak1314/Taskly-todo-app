  ...
  return (
    ...
    <Navbar/> 
       <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 
                ...
                text-black dark:text-white shadow-xl 
                min-h-[80vh] md:w-[38%] transition-all duration-500">


        <h1 className='font-bold text-center text-3xl'>Taskly - Manage your todos at one place</h1>
         <div className="addTodo my-7 flex flex-col gap-4">
         ...
         <h2 className='text-2xl font-bold my-3'>Your Todos</h2>
         <div className="todos">
